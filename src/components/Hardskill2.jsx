  ...
  return (
    <div className="w-screen max-w-6xl mx-auto bg-black text-white border-2 border-violet-500 rounded-2xl shadow-lg p-5 flex items-center gap-6 h-48 relative">
      <div className="flex-1">
        <h2 className="text-[15px] sm:text-xl font-bold">iOS & Swift - The Complete iOS App Development Bootcamp from Udemy</h2>

        {/* Desktop Description */}
        <p className="mt-2 text-sm hidden sm:block">
          Learning programming in iOS using swift and many more tools such as SwiftUI, cocoapods, sqlite, Realm, CoreData, 
          Firebase, Core ML, and many more.
        </p>
